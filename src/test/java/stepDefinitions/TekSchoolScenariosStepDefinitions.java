...
@When("^User sends query'select * from public.customer where email='john.farnsworth@sakilacustomer.org''$")
public void user_sends_query_select_from_public_customer_where_email_john_farnsworth_sakilacustomer_org(String emialValidation) throws Throwable {
    // Write code here that turns the phrase above into concrete actions
